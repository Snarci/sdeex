...
if __name__ == '__main__':
    ...
    extract_features(model, test_loader, classes, f"{args.output_path}/{model_name}_test.h5")
    extract_features(model, train_loader, classes, f"{args.output_path}/{model_name}_train.h5")